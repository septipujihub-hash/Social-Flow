              ...
              <div className="glass-card p-8 soft-shadow flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <span className="px-3 py-1 rounded-full bg-emerald-100 text-emerald-600 text-[10px] font-black uppercase tracking-widest">{t('pro_plan')}</span>
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-8">
                    <div>
                      ...
                      <h3 className="text-3xl font-display font-bold tracking-tight">{t('pro_plan')}</h3>
                    </div>
                    <div className="bg-white/20 backdrop-blur-md px-4 py-2 rounded-xl text-xs font-bold shadow-lg">
                      {t('trial_ends_in', { days: 8 })}
                    </div>
                  </div>
                  ...
                  <div className="flex gap-1 items-baseline mb-8">
                    <span className="text-4xl font-display font-bold font-black">$10</span>
                    <span className="text-xs opacity-70 font-medium">/month</span>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="w-full h-3 bg-slate-100 rounded-full overflow-hidden">
                      <div className="w-[42%] h-full gradient-bg rounded-full shadow-[0_0_15px_rgba(16,185,129,0.3)]" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="w-full h-3 bg-slate-100 rounded-full overflow-hidden">
                      <div className="w-[15%] h-full gradient-bg rounded-full" />
                    </div>
                  </div>
                </div>
              </div>
                 ...
                 <div className="overflow-x-auto">
                   <table className="w-full">
                     ...
                     <tbody className="divide-y divide-slate-50">
                       {[
                         { id: 'INV-2024-001', date: 'May 15, 2024', amount: '$24.00', status: 'Paid' },
                         { id: 'INV-2024-002', date: 'Apr 15, 2024', amount: '$24.00', status: 'Paid' },
                         { id: 'INV-2024-003', date: 'Mar 15, 2024', amount: '$24.00', status: 'Paid' },
                         { id: 'INV-2024-004', date: 'Feb 15, 2024', amount: '$24.00', status: 'Failed' },
                       ].map((invoice, i) => (
                         <tr key={i} className="group hover:bg-slate-50 transition-colors">
                            <td className="py-4 text-sm font-bold text-slate-700">{invoice.id}</td>
                            <td className="py-4 text-sm text-slate-500 font-medium">{invoice.date}</td>
